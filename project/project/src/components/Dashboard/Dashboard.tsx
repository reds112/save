...
import { Plus, Users, Monitor, Settings, LogOut, Search, Filter } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <form onSubmit={handleJoinSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-green-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-green-700 focus:ring-4 focus:ring-green-200 transition-all flex items-center justify-center gap-2"
              >
